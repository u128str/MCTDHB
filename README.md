...
2) To download zip-archive LR-MCTDHB:  
 a) ````git clone -b MCTDHB_V3.3.02 https://github.com/u128str/MCTDHB.git````
 b) ````wget --no-check-certificate --content-disposition https://github.com/u128str/MCTDHB/blob/MCTDHB_V3.3.02/MCTDHB-MCTDHB_V3.3.02.zip````
 c) ````curl -LJO https://github.com/u128str/MCTDHB/blob/MCTDHB_V3.3.02/MCTDHB-MCTDHB_V3.3.02.zip````
