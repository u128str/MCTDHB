...
__global__ void  kinetic_3D( cuDoubleComplex *vec2, 
                             cuDoubleComplex *ax, 
                             cuDoubleComplex *ay, 
                             cuDoubleComplex *az,
 ...
 {    
     ...
     void  kinetic_CPU_3D(   cuDoubleComplex *vec2, 
                             cuDoubleComplex *ax, 
                             cuDoubleComplex *ay, 
                             cuDoubleComplex *az,
                             int NX, int NY, int NZ)
...
extern "C" void   kernel_fft_3d_(cuDoubleComplex *psi,
...
/* -------------- Create a 3D FFT plans. ------------------------------------  */
               
                  cufftPlan3d(&plan,NDZ, NDY, NDX, CUFFT_Z2Z); 

                   printf("Cufft_3D-FULL\n");
...
/* ------    Use the CUFFT plan to transform the signal in place.  ---------  */
         ...
         //1       {
          ...
          //2      cufftExecZ2Z(plan2, psi_d, psi_d, CUFFT_FORWARD);
...
/*---------- call function on GPU -------------------------------------------  */
             ...
             kinetic_3D<<<blocks,threads>>>( psi_d, ortkx_d, ortky_d, ortkz_d, NDX, NDY,NDZ);
...
//------------------------  PROOF -  -----------------------
   /*    
             cudaMemcpy(psi, psi_d, sizeof(cuDoubleComplex) *NDIM, cudaMemcpyDeviceToHost);
              ...
              kinetic_CPU_3D ( psi, ortkx, ortky, ortkz, NDX, NDY, NDZ);
...
//--------------------------------------------------------------------------------------------
       ...
       //2         cufftExecZ2Z(plan2, psi_d, psi_d, CUFFT_INVERSE);
