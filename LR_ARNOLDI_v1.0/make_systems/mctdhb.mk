...
add_dep=
#RES=  $(MODS) ./bin/boson_MCTDHB_$(cmp)_$(FFT) ./bin/properties_LR_$(cmp)_$(FFT) info ./bin/lr_arnoldi_$(cmp)_$(FFT)  info 
RES=  $(MODS) ./bin/boson_MCTDHB_$(cmp)_$(FFT) ./bin/lr_arnoldi_$(cmp)_$(FFT) info 
ifeq ($(comp_mode),Split)
add_dep= libguess.a
endif
...
clean:
	rm -r  *.a ./external/*.o ./external/*.mod ./source/*.o ./*.mod ./user_guesslib/libguess.so ./user_guesslib/*.o ./*.o ./bin/* ./source/FFTMKL/*.o ./source/FFTFFTW/*.o ./source/FFTCUDACPP/*.o  ./source/FFTCUDAPGI/*.o ./source/FFTCUDAPGI/*.mod  properties_LR/*.o properties_LR/*.mod LR_ARNOLDI/*.o LR_ARNOLDI/*.mod ./libguess.so  
