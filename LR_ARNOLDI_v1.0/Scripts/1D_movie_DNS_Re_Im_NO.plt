#    G N U P L O T
# thisscript 1D_movie_DNS_Re_Im_NO.plt
print "GIF usage: gnuplot  -e \"Morb=2; Time_Bgn=0.0; Time_Fnl=11; dt=0.2 \"  thisscript"
print "OUT animated gif: ./media/1D_DNS_Re_Im_NO.gif"
...
print "OUT single-shot jpeg: ./media/10.0000000timeNatOrbReIm.jpeg"
...
fileout1=sprintf("%s%.10stimeNatOrbReIm.jpeg",dirOUT,filein1)
...
filein=sprintf("%s%.10stime.dat",dirIN,filein1)
fileout1="./media/1D_DNS_Re_Im_NO.gif"
...
for[i=1:Morb] "" using 1: (column(2*Morb+2*(i-1)+11)/column(4) +(Morb-i+1)*0.75+0.1) \
