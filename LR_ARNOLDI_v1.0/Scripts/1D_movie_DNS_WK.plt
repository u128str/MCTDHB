...
print "OUT single-shot jpeg: ./media/10.0000000WrkOrb.jpeg"
...
fileout1=sprintf("%s%.10stimeWrkOrb.jpeg",dirOUT,filein1)
...
set yrange [Y1:Y2]
do for [j=1:n]{
Fulltitle=sprintf("Working MCTDHB(%i) Orbitals at T=%2.3f",Morb,Time+dt*(j-1))
set title Fulltitle 
