...
!     write(6,*)MYID,"GetCIJKL2body_Par 0" 
      ...
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_51_OMP(MYID,VIN) 
                    CASE (52) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_52_OMP(MYID,VIN) 
                    CASE (53) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_53_OMP(MYID,VIN) 
                    CASE (54) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_54_OMP(MYID,VIN) 
                    CASE (55) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_55_OMP(MYID,VIN) 
                    CASE (56) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_56_OMP(MYID,VIN) 
                    CASE (57) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_57_OMP(MYID,VIN) 
                    CASE (58) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_58_OMP(MYID,VIN) 
                    CASE (59) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_59_OMP(MYID,VIN) 
                    CASE (60) 
      IF(CI_Production_2b.eqv..TRUE.) CALL PrdCIJKL2body_M_OMP(MYID,VIN)
      IF(CI_Production_2b.eqv..FALSE.) &
                       CALL GetCIJKL2body_60_OMP(MYID,VIN) 
                          CASE (61:100)
