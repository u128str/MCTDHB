...
C      CALL F (N, T, Y, ZWORK(LF0), RPAR, IPAR)
      NFE = 1
...
C      CALL ZVHIN (N, T, ZWORK(LYH), ZWORK(LF0), F, RPAR, IPAR, TOUT,
C     1   UROUND, RWORK(LEWT), ITOL, ATOL, Y, ZWORK(LACOR), H0,
C     2   NITER, IER)
...
C-----------------------------------------------------------------------
     ...
     2   F, JAC, F, ZVNLSD)
C      CALL ZVSTEP (Y, ZWORK(LYH), NYH, ZWORK(LYH), RWORK(LEWT),
C     1   ZWORK(LSAVF), Y, ZWORK(LACOR), ZWORK(LWM), IWORK(LIWM),
C     2   F, JAC, F, ZVNLSD, RPAR, IPAR)
...
C      SUBROUTINE ZVHIN (N, T0, Y0, YDOT, F, RPAR, IPAR, TOUT, UROUND,
...
C If JOK = -1 and MITER = 1, call JAC to evaluate Jacobian. ------------
      ...
      DO 110 I = 1,LENP
 110    WM(I) = ZERO
C      CALL JAC (N, TN, Y, 0, 0, WM, N, RPAR, IPAR)
...
C      CALL JAC (N, TN, Y, ML, MU, WM(ML1), MEBAND, RPAR, IPAR)
      IF (JSV .EQ. 1)
