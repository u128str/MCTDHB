...
err=9.0e-3
plot  [X1:X2] [] \
filein  using 1:(column(Morb+3)) t "Assumed Error" w l lt -1 lw lwv,\
filein  using 1:(column(Morb+5)) t "Actual Error" w l lt 1  lw lwv
...
set logscale y 
plot  [X1:X2] [1.0e-18:*] \
filein  using 1:Morb+3 t "Assumed Err" w l lt -1 lw lwv,\
filein  using 1:Morb+6 t "CI Error %"  w l lt  3 lw lwv,\
filein  using 1:Morb+7 t "PSI Error %" w l lt  4 lw lwv 
